...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['username'])) {
    ...
    if (strlen($username) < 6) {
        ...
        if ($remoteUserId) {
            $stmt = $conn->prepare("UPDATE user_friends SET is_blocked = CASE is_blocked WHEN 0 THEN 1 ELSE 0 END WHERE
            ...
            if ($stmt) {
                ...
                $response['Err'] = 'No Such User In Your Friend List,User is already blocked !';
            }
        } else {
